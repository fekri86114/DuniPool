...
import fekri.io.R
import fekri.io.databinding.ActivityCoinBinding
import fekri.io.ux.adapter.ChartAdapter
import fekri.io.ux.apiManager.*
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dataThisCoinAbout =
            if (fromIntent.getParcelable<CoinAboutItem>("bundle2") != null)
                fromIntent.getParcelable<CoinAboutItem>("bundle2")!!
            else
                CoinAboutItem()
